...
context = pd.read_csv('dataset/context_ONLY-ACTION-SPREAD60_K3_H4_P12.csv')
...
context.to_csv('dataset/context_ONLY-ACTION-SPREAD60_K3_H4_P12-BINARY.csv', index=False)
