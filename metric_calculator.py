...
df = pd.read_csv('dataset/india-election-tweets-reduced.csv', on_bad_lines='skip')
...
aff_path2 = "anew_val_polarity.xlsx"

affdf2 = pd.read_excel(aff_path2)
...
mfd = pd.read_csv("dictionaries/mfd.tsv", sep='\t')
...
pdict = pd.read_csv("dictionaries/lang_online_polarization_dict.csv")
...
abuse = pd.read_excel("abuseLexicon.xlsx")
